...
NA2hd1[, "dgp"] <- 1
save(NA2hd1, file = "12NA2hochdim1neu.Rda")
...
# ntest im Test-Datensatz, 200 je Lern-Datensatz, dgpfun.niter Lern-Datensätze
NA2hd2[, "dgp"] <- 2
save(NA2hd2, file = "12NA2hochdim2neu.Rda")

# Datenaufbereitung:
#-------------------

NA2hochdim <- rbind(NA2hochdim1, NA2hochdim2)
...
save(NA2hochdim, file = "12NA2hochdimneu.Rda")
